...
public:
	MazeFinder(Maze * maze) : maze(maze)
	{
...
//******IS MOVE AVAILABLE
	bool moveAvailable()
	{
		...
		else if (x + 1 < maze->GetXLength() && maze->GetMazeAt(x+1, y) == ' ')
		{
			return true;
		}
		...
		else if (y + 1 < maze->GetYLength() && maze->GetMazeAt(x, y+1) == ' ')
		{
			return true;
		}
